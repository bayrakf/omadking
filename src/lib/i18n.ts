...
const EN = {
  ...
  'card.patternPremium':
    'Your days are not alike — one of them runs well over the rest. Premium names it and works out what it costs across a week.',
  ...
  'meas.yoursNow': 'This is the figure you spent two weeks earning. It moves as you get lighter — Premium keeps measuring it and pulls your daily target along with it.',
  'meas.sellKeep': 'Keep it moving',
  'meas.sellShow': 'See what it measured',
  ...
  'meas.basedOn': "Measured from {days} days of eating and {weighIns} weigh-ins. The formula's estimate is off — Premium shows by how much and moves your target to the measured figure.",
...
const DE: Record<Key, string> = {
  ...
  'meas.yoursNow': 'Diesen Wert hast du dir über zwei Wochen erarbeitet. Er passt sich an, wenn du leichter wirst — Premium misst ihn kontinuierlich weiter und führt dein Tagesziel mit.',
  'meas.sellKeep': 'Keep it moving',
  'meas.sellShow': 'See what it measured',
  ...
  'meas.basedOn': "Ermittelt aus {days} days Ernährung und {weighIns} Wägungen. Die Formel liegt daneben — The formula's estimate is off — Premium zeigt den genauen Wert und passt dein Tagesziel an.",
