...
const WORKOUTS: WorkoutPlan[] = [
  {
    ...
    fastingNote: '500ml Wasser + 500mg Natrium 30 Min. vor dem Training trinken. Maximale Insulinsensitivität für das anschließende Essensfenster.',
    exercises: [
      { name: 'Schrägbankdrücken (Kurzhantel)', sets: '4 Sätze × 8–10 Wdh.', notes: '2 Min. Pause' },
      { name: 'Dips / Barrenstütz', sets: '3 Sätze × 10–12 Wdh.', notes: 'Körpergewicht oder Zusatzlast' },
      { name: 'Überkopfdrücken (Military Press)', sets: '3 Sätze × 8–10 Wdh.', notes: 'Fokus auf Rumpfspannung' },
      { name: 'Seitheben am Kabel / Kurzhantel', sets: '4 Sätze × 12–15 Wdh.', notes: 'Kurze Pausen 60s' },
      { name: 'Trizepsdrücken am Seil', sets: '3 Sätze × 12–15 Wdh.', notes: 'Spitzenkontraktion halten' },
    ],
  },
  {
    id: 'pull-fasted',
    ...
    exercises: [
      { name: 'Klimmzüge (breiter Griff)', sets: '4 Sätze × 6–8 Wdh.', notes: 'Saubere Dehnung im Lat' },
      { name: 'Langhantel-Rudern vorgebeugt', sets: '4 Sätze × 8–10 Wdh.', notes: 'Stabiler unterer Rücken' },
      { name: 'Latzug zur Brust (enger Griff)', sets: '3 Sätze × 10–12 Wdh.', notes: 'Kontrollierte Exzentrik' },
      { name: 'Face Pulls für hintere Schulter', sets: '4 Sätze × 15 Wdh.', notes: 'Schultergesundheit' },
      { name: 'Schrägbank-Bizepscurls', sets: '3 Sätze × 10–12 Wdh.', notes: 'Voller Bewegungsumfang' },
    ],
  },
  {
    id: 'legs-fasted',
    ...
    fastingNote: 'Größter Glykogen-Verbrauch. Plane das Fastenbrechen innerhalb von 45–60 Min. nach Trainingsende.',
    exercises: [
      { name: 'Kniebeugen (Barbell Squat)', sets: '4 Sätze × 6–8 Wdh.', notes: '3 Min. Satzpause' },
      { name: 'Rumänisches Kreuzheben (RDL)', sets: '3 Sätze × 8–10 Wdh.', notes: 'Fokus auf Beinbeuger & Gluteus' },
      { name: 'Beinpresse 45°', sets: '3 Sätze × 10–12 Wdh.', notes: 'Tiefe Ausführung' },
      { name: 'Beinstrecker & Beinbeuger Supersatz', sets: '3 Sätze × 12–15 Wdh.', notes: 'Maximaler Pump' },
      { name: 'Wadenheben stehend', sets: '4 Sätze × 15 Wdh.', notes: '2 Sek. Halt am obersten Punkt' },
    ],
  },
  {
    id: 'zone2-cardio',
    ...
    exercises: [
      { name: 'Lockerer Dauerlauf / Joggen', sets: '45 Min. kontinuierlich', notes: 'Gleichmäßiges Tempo' },
      { name: 'Alternativ: Radergometer / Stairmaster', sets: '45 Min. gleichmäßig', notes: 'Trittfrequenz ~85 RPM' },
      { name: 'Alternativ: Rucking (Rucksack 10-15kg)', sets: '45 Min. zügiges Gehen', notes: 'Hervorragende Gelenkschonung' },
    ],
  },
  {
    id: 'hiit-fasted',
    ...
    exercises: [
      { name: 'Kettlebell Swings', sets: '5 Runden: 40s Belastung / 20s Pause', notes: 'Explosive Hüftstreckung' },
      { name: 'Burpees ohne Liegestütz', sets: '5 Runden: 40s Belastung / 20s Pause', notes: 'Rhythmus halten' },
      { name: 'Assault Bike / Rower Sprints', sets: '5 Runden: 30s All-Out / 30s Pause', notes: 'Maximaler Laktatausstoß' },
      { name: 'Plank to Push-up', sets: '5 Runden: 40s Belastung / 20s Pause', notes: 'Rumpfstabilität' },
    ],
  },
  {
    id: 'mobility-fasted',
    ...
    exercises: [
      ...
      { name: '90/90 Hüftrotationen', sets: '2 Min. dynamischer Wechsel', notes: 'Hüftöffner' },
      { name: 'Katze-Kuh & Thorakale Rotation', sets: '10 kontrollierte Wiederholungen', notes: 'Wirbelsäulen-Mobilisation' },
      { name: 'Couch Stretch (Hüftbeuger)', sets: '2 Min. Halten pro Seite', notes: 'Gegen sitzende Haltung' },
      { name: 'Tiefe Kniebeuge im Sitzen (Deep Squat Hold)', sets: '2 Min. Halten', notes: 'Knöchel- & Hüftbeweglichkeit' },
    ],
  },
];
